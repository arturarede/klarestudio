            ...
            {!showDetails ? (
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  <p className="text-sm font-[600] text-[#1C1916]">{t.detailsTitle}</p>
                  <button
                ...
                <div className="space-y-3 mb-5">
                  ...
                  <div className="flex items-start justify-between gap-4 p-3 rounded-xl bg-[#1C1916]/[0.03]">
                    <div>
                      <p className="text-xs font-[600] text-[#1C1916] mb-0.5">{t.necessaryTitle}</p>
                      <p className="text-[11px] text-[#1C1916]/45 font-[300] leading-relaxed">
                        {t.necessaryDesc}
                      </p>
                    </div>
                    <div className="flex-shrink-0 mt-0.5">
                      <span className="text-[10px] font-[500] text-[#B89B6A] tracking-wide uppercase">{t.alwaysActive}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start justify-between gap-4 p-3 rounded-xl bg-[#1C1916]/[0.03]">
                    <div>
                      <p className="text-xs font-[600] text-[#1C1916] mb-0.5">{t.analyticsTitle}</p>
                      <p className="text-[11px] text-[#1C1916]/45 font-[300] leading-relaxed">
                        {t.analyticsDesc}
                      </p>
                    </div>
